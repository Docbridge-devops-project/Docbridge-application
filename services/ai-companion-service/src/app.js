...
app.get('/healthz', (req, res) => res.status(200).json({ status: 'ok', service: 'ai-companion-service', probe: 'liveness' }));

app.get('/ready', (req, res) => res.status(200).json({ status: 'ready', service: 'ai-companion-service', probe: 'readiness' }));
