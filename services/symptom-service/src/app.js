...
app.get('/healthz', (req, res) => res.status(200).json({ status: 'ok', service: 'symptom-service', probe: 'liveness' }));

app.get('/ready', (req, res) => res.status(200).json({ status: 'ready', service: 'symptom-service', probe: 'readiness' }));
