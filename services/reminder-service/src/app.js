...
app.get('/health', (req, res) => {
  res.status(200).json({ status: 'ok', service: 'reminder-service' });
});

app.get('/healthz', (req, res) => res.status(200).json({ status: 'ok', service: 'reminder-service', probe: 'liveness' }));

app.get('/ready', (req, res) => res.status(200).json({ status: 'ready', service: 'reminder-service', probe: 'readiness' }));
