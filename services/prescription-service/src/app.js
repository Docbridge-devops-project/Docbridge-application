...
app.get('/health', (req, res) => {
  res.status(200).json({ status: 'ok', service: 'prescription-service' });
});

app.get('/healthz', (req, res) => res.status(200).json({ status: 'ok', service: 'prescription-service', probe: 'liveness' }));

app.get('/ready', (req, res) => res.status(200).json({ status: 'ready', service: 'prescription-service', probe: 'readiness' }));
