...
app.get('/health', (req, res) => {
  res.status(200).json({ status: 'ok', service: 'consultation-service' });
});

app.get('/healthz', (req, res) => res.status(200).json({ status: 'ok', service: 'consultation-service', probe: 'liveness' }));

app.get('/ready', (req, res) => res.status(200).json({ status: 'ready', service: 'consultation-service', probe: 'readiness' }));
